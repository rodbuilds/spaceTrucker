# quantum-trade-ai Specification

## Purpose

Provide a paid Quantum Trading AI merchant at every Trading Post and Faction Headquarters of Economy-assigned factions. The merchant produces a Trade Report — a journal-wide aggregation of the player's best buy/sell observations with station attribution — and serves as the entry point for acquiring Faction Surveys.
