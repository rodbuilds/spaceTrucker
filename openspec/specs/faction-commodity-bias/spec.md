...
Assign hidden economic archetypes to NPC factions and apply trait-driven, per-faction commodity price biases at the merchant boundary, so that station prices reflect each faction's economic character.
